...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        $dbContext->updateUser($_SESSION['auth_user_id'], $givenName, $street, $city, $zip, $role);
...
<p>
    ...
    <div class="radio-input">
        <input type="radio" id="student" name="role" value="student" <?php if(isset($userData['accountrole']) && $userData['accountrole'] == 'student') echo 'checked'; ?>>
        <label for="student">Student</label>    
    </div>
    <div class="radio-input">
        <input type="radio" id="teacher" name="role" value="teacher" <?php if(isset($userData['accountrole']) && $userData['accountrole'] == 'teacher') echo 'checked'; ?>>
