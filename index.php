...
<div class="row-1">
    <div class="info-container">
        ...
        <p>Streamlined administration and communication in one place. <br> <b>EduQ</b> - the comprehensive solution for
            school efficiency and effectiveness.</p>
        ...
        <div class="costumer-container">
            <p><i class="fa-solid fa-circle-question"></i><b> Already a customer?</b> <a
                    href="<?php echo ($dbContext->getUsersDatabase()->getAuth()->isLoggedIn()) ? '/CreateQueueRoom.php' : '/AccountLogin.php'; ?>">Get
                    started!</a></p>
...
<div class="row-2">
    ...
    <div class="functionality-container">
        <h2 id="messenger"></h2>
        <p>EduQ is meticulously designed to streamline school operations across all demographics, fostering inclusivity
            and efficiency. It provides a secure foundation for seamless management.</p>
